...
using Amphipods = std::array<Amphipod, 16>;
...
private:
    ...
    std::tuple<int, int, int, int> amphipod_type_to_room_locations(AmphipodTypes room_type)
    {
        switch (room_type) {
        case AmphipodTypes::A:
            return { 20, 21, 22, 23 };
    ...
    {
        auto [first_room, second_room, third_room, fourth_room] = amphipod_type_to_room_locations(room_type);
        ...
        auto amphipod_at_third_room = ranges::find(all_amphipods, third_room, &Amphipod::location);
        if (amphipod_at_first_room == ranges::end(all_amphipods)) {
            return first_room;
        }
        if ((*amphipod_at_first_room).type == room_type && amphipod_at_second_room == ranges::end(all_amphipods)) {
            return second_room;
        }
        if ((*amphipod_at_first_room).type == room_type && (*amphipod_at_second_room).type == room_type && amphipod_at_third_room == ranges::end(all_amphipods)) {
            return third_room;
        }
        if ((*amphipod_at_first_room).type == room_type && (*amphipod_at_second_room).type == room_type && (*amphipod_at_third_room).type == room_type) {
            auto amphipod_at_fourth_room = ranges::find(all_amphipods, fourth_room, &Amphipod::location);
            if (amphipod_at_fourth_room == ranges::end(all_amphipods)) {
                return fourth_room;
            }
        }
        return {};
    ...
    int get_cost(Amphipod amphipod, int target)
    {
        ...
        if (current_location > 10) {
            ...
            if (remainder == 0) additional_steps += 4;
            if (remainder == 1) additional_steps += 3;
            if (remainder == 2) additional_steps += 2;
            if (remainder == 3) additional_steps += 1;
        }
        if (target > 10) {
    ...
    bool should_move(const Amphipod &amphipod, const Amphipods &all_amphipods)
    {
        ...
        case AmphipodTypes::A: {
            auto amphipod_at_first_room = ranges::find(all_amphipods, 20, &Amphipod::location);
            auto amphipod_at_second_room = ranges::find(all_amphipods, 21, &Amphipod::location);
            if (amphipod.location == 20) return false;
            if (amphipod.location == 21) {
                if (amphipod_at_first_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::A) return false;
                return true;
            }
            if (amphipod.location == 22) {
                if (amphipod_at_first_room == ranges::end(all_amphipods) || amphipod_at_second_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::A && (*amphipod_at_second_room).type == AmphipodTypes::A) return false;
                return true;
            }
            if (amphipod.location == 23) {
                auto amphipod_at_third_room = ranges::find(all_amphipods, 22, &Amphipod::location);
                if (amphipod_at_first_room == ranges::end(all_amphipods) || amphipod_at_second_room == ranges::end(all_amphipods) || amphipod_at_third_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::A && (*amphipod_at_second_room).type == AmphipodTypes::A && (*amphipod_at_third_room).type == AmphipodTypes::A) return false;
                return true;
            }
            return true;
        }
        case AmphipodTypes::B: {
            auto amphipod_at_first_room = ranges::find(all_amphipods, 40, &Amphipod::location);
            auto amphipod_at_second_room = ranges::find(all_amphipods, 41, &Amphipod::location);
            if (amphipod.location == 40) return false;
            if (amphipod.location == 41) {
                if (amphipod_at_first_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::B) return false;
                return true;
            }
            if (amphipod.location == 42) {
                if (amphipod_at_first_room == ranges::end(all_amphipods) || amphipod_at_second_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::B && (*amphipod_at_second_room).type == AmphipodTypes::B) return false;
                return true;
            }
            if (amphipod.location == 43) {
                auto amphipod_at_third_room = ranges::find(all_amphipods, 42, &Amphipod::location);
                if (amphipod_at_first_room == ranges::end(all_amphipods) || amphipod_at_second_room == ranges::end(all_amphipods) || amphipod_at_third_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::B && (*amphipod_at_second_room).type == AmphipodTypes::B && (*amphipod_at_third_room).type == AmphipodTypes::B) return false;
                return true;
            }
            return true;
        }
        case AmphipodTypes::C: {
            auto amphipod_at_first_room = ranges::find(all_amphipods, 60, &Amphipod::location);
            auto amphipod_at_second_room = ranges::find(all_amphipods, 61, &Amphipod::location);
            if (amphipod.location == 60) return false;
            if (amphipod.location == 61) {
                if (amphipod_at_first_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::C) return false;
                return true;
            }
            if (amphipod.location == 62) {
                if (amphipod_at_first_room == ranges::end(all_amphipods) || amphipod_at_second_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::C && (*amphipod_at_second_room).type == AmphipodTypes::C) return false;
                return true;
            }
            if (amphipod.location == 63) {
                auto amphipod_at_third_room = ranges::find(all_amphipods, 62, &Amphipod::location);
                if (amphipod_at_first_room == ranges::end(all_amphipods) || amphipod_at_second_room == ranges::end(all_amphipods) || amphipod_at_third_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::C && (*amphipod_at_second_room).type == AmphipodTypes::C && (*amphipod_at_third_room).type == AmphipodTypes::C) return false;
                return true;
            }
            return true;
        }
        case AmphipodTypes::D: {
            auto amphipod_at_first_room = ranges::find(all_amphipods, 80, &Amphipod::location);
            auto amphipod_at_second_room = ranges::find(all_amphipods, 81, &Amphipod::location);
            if (amphipod.location == 80) return false;
            if (amphipod.location == 81) {
                if (amphipod_at_first_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::D) return false;
                return true;
            }
            if (amphipod.location == 82) {
                if (amphipod_at_first_room == ranges::end(all_amphipods) || amphipod_at_second_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::D && (*amphipod_at_second_room).type == AmphipodTypes::D) return false;
                return true;
            }
            if (amphipod.location == 83) {
                auto amphipod_at_third_room = ranges::find(all_amphipods, 82, &Amphipod::location);
                if (amphipod_at_first_room == ranges::end(all_amphipods) || amphipod_at_second_room == ranges::end(all_amphipods) || amphipod_at_third_room == ranges::end(all_amphipods)) return true;
                if ((*amphipod_at_first_room).type == AmphipodTypes::D && (*amphipod_at_second_room).type == AmphipodTypes::D && (*amphipod_at_third_room).type == AmphipodTypes::D) return false;
                return true;
            }
            return true;
        }
    ...
    bool is_solved(const Amphipods &amphs)
    {
        return ranges::all_of(amphs, [](const auto &amph) {
            switch (amph.type) {
            case AmphipodTypes::A:
                return amph.location == 20 || amph.location == 21 || amph.location == 22 || amph.location == 23;
            case AmphipodTypes::B:
                return amph.location == 40 || amph.location == 41 || amph.location == 42 || amph.location == 43;
            case AmphipodTypes::C:
                return amph.location == 60 || amph.location == 61 || amph.location == 62 || amph.location == 63;
            case AmphipodTypes::D:
                return amph.location == 80 || amph.location == 81 || amph.location == 82 || amph.location == 83;
            default:
...
auto main() -> int
{
    ...
    */
    ...
    //       Amphipod{ 21, AmphipodTypes::D },
    //       Amphipod{ 22, AmphipodTypes::D },
    //       Amphipod{ 23, AmphipodTypes::B },

    //       Amphipod{ 40, AmphipodTypes::D },
    //       Amphipod{ 41, AmphipodTypes::C },
    //       Amphipod{ 42, AmphipodTypes::B },
    //       Amphipod{ 43, AmphipodTypes::C },

    //       Amphipod{ 60, AmphipodTypes::C },
    //       Amphipod{ 61, AmphipodTypes::A },
    //       Amphipod{ 62, AmphipodTypes::B },
    //       Amphipod{ 63, AmphipodTypes::B },

    //       Amphipod{ 80, AmphipodTypes::A },
    //       Amphipod{ 81, AmphipodTypes::C },
    //       Amphipod{ 82, AmphipodTypes::A },
    //       Amphipod{ 83, AmphipodTypes::D } }
    // };
    /*
    #############
    #...........#
    ...
    */
    Amphipods initial_layout{
        { Amphipod{ 20, AmphipodTypes::B },
          Amphipod{ 21, AmphipodTypes::D },
          Amphipod{ 22, AmphipodTypes::D },
          Amphipod{ 23, AmphipodTypes::C },

          Amphipod{ 40, AmphipodTypes::C },
          Amphipod{ 41, AmphipodTypes::B },
          Amphipod{ 42, AmphipodTypes::C },
          Amphipod{ 43, AmphipodTypes::B },

          Amphipod{ 60, AmphipodTypes::D },
          Amphipod{ 61, AmphipodTypes::A },
          Amphipod{ 62, AmphipodTypes::B },
          Amphipod{ 63, AmphipodTypes::A },
