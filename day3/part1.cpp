...
int main()
{
    ...
    auto gamma_rate = ranges::accumulate(gamma_rate_bits | ranges::views::reverse, 0, [](auto acc, auto v) { return (acc << 1) | v; });

    auto epsilon_rate = ranges::accumulate(gamma_rate_bits | ranges::views::reverse, 0, [](auto acc, auto v) { return (acc << 1) | (v ^ 1); });
