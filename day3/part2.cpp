...
bool get_most_common_bit(InputIt first, InputIt last, long unsigned number_of_bits, unsigned ind)
{
...
int main()
{
    ...
    for (unsigned i = 0; i < number_of_bits; ++i) {
        ...
        end_iter = std::partition(std::begin(values), end_iter, [get_ith_position_bit, i, most_common_value](auto value) { return get_ith_position_bit(value, i) == most_common_value; });
